...
The complete workflow is summarized in figure~\ref{fig:framework_workflow}. The protocol separates source-domain training, external-domain adaptation, weakly guided pseudo-label filtering, locked external testing, and third-domain evaluation to avoid mixing training evidence with final evaluation evidence.
