...
| Frozen release link | `https://github.com/yuningwuyn-lgtm/oil-palm-ffb-ssod/releases/tag/v1.0.3-jae-final-submission-links` | Add if the system asks for a versioned software/archive link. |
...
- Frozen release version: `v1.0.3-jae-final-submission-links`.
